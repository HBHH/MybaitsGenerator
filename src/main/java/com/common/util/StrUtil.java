...
public class StrUtil {
	...
	/**
	 * 把包含字符串和数字的字符串分割成纯字符串和数字：如werqwe3433分割为werqwe,3433
	 * @param str 字符串 如：werqwe3433
	 * @return 包含字符串和数字的数组
	 */
	public static List<String> splitStrAndNumber(String strNumber) {
        ...
        while (m.find()) {
        	strNumberList.add((m.group()));
        }
        return strNumberList;
	}
	public static void main(String[] args) {
		String dd = fileNameAddTime("xxx.jpg");
		System.out.print(dd);
	}
}